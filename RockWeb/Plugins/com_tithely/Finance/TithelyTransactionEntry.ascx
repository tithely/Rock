<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TithelyTransactionEntry.ascx.cs" Inherits="RockWeb.Blocks.Finance.TransactionEntry" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-3" style="padding-left:0;">
                                                <Rock:RockCheckBox ID="rcbCoverFees" Label="Cover Fees?" Help="Check this box if you would like to cover the processing fees" runat="server" Checked="false" Data-Testid="Cover Fees Checkbox" />
                                            </div>
                                        </div>
            ...
            <div class="panel panel-default no-border">
                <div class="panel-body">
                    ...
                    <div class="actions clearfix">
                        ...
                        <asp:Label ID="aStep2Submit" runat="server" ClientIDMode="Static" CssClass="btn btn-primary pull-right js-step2-submit" Text="Next" Data-Testid="Next" />
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <dl class="dl-horizontal gift-confirmation margin-b-md">
                            ...
                            <% if (CoverFees)
                            { %>
                                <Rock:TermDescription Id="tdFeesCovered" runat="server" Term="Fees Covered" />
                            <% } %>
        ...
        <asp:Panel ID="pnlSuccess" runat="server" Visible="false">
            ...
            <div class="well">
                ...
                <dl class="dl-horizontal gift-success">
                    ...
                    <% if (CoverFees)
                    { %>
                        <Rock:TermDescription Id="tdFeeTotalReceipt" runat="server" Term="Fees Covered" />
                    <% } %>
